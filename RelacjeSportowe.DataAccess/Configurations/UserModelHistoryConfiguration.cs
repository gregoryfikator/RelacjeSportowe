...
{
    public class UserModelHistoryConfiguration : IEntityTypeConfiguration<UserHistory>
    {
        public void Configure(EntityTypeBuilder<UserHistory> builder)
        {
            ...
            builder.ToTable("UsersHistory");

            builder.HasKey(x => x.Id);

            builder.HasOne(x => x.Role)
                .WithOne()
                .HasForeignKey<UserHistory>(x => x.RoleId);
            ...
            builder.HasOne(x => x.ModifiedBy)
                .WithOne()
                .HasForeignKey<UserHistory>(x => x.ModifiedById);
        }
    }
}
